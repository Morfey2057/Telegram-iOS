        ...
        switch self {
            ...
            case let .message(message, peer, readState, threadInfo, presentationData, _, selected, displayCustomHeader, orderingKey, _, _, allPaused, storyStats):
                ...
                if isMedia {
					...
					)), editing: false, hasActiveRevealControls: false, selected: false, header: tagMask == nil ? header : nil, enableContextActions: false, hiddenOffset: false, offsetReduce: nil, interaction: interaction)
                }
